...
export const menu = [
  {
    ...
    listItems: [
      ...
      { id: 2, title: "Calendar", url: "/users/1", icon: Kalendar },
      { id: 3, title: "Halteverbotszonen", url: "/users/1", icon: hvz },
      { id: 4, title: "Lagerung", url: "/users/1", icon: lagerung },
      { id: 5, title: "Rechnungen", url: "/users/1", icon: rechnung },
      { id: 6, title: "Ausgaben", url: "/users/1", icon: ausgaben },
      { id: 7, title: "KVA", url: "/users/1", icon: kva },
    ],
  },
];
